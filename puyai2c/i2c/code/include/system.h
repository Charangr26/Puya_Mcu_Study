...
#define RCC_CFGR_SW_HSI 0x00U  // Example value; replace with actual value from the reference manual
#endif

#ifndef RCC_CFGR_SW
#define RCC_CFGR_SW 0x03U  // Example value; replace with actual value from the reference manual
#endif

#ifndef RCC_CFGR_SWS_HSI
#define RCC_CFGR_SWS_HSI 0x00U  // Example value; replace with actual value from the reference manual
#endif

#ifndef RCC_CR_HSION
#define RCC_CR_HSION 0x01U  // Example value; replace with actual value from the reference manual
#endif

#ifndef RCC_CR_HSIRDY
#define RCC_CR_HSIRDY 0x02U  // Example value; replace with actual value from the reference manual
#endif